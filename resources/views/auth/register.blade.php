    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="text-secondary mt-2">
                <p>本アプリには退会機能が備わっています。</p>
                <p>アプリの雰囲気を気軽にお試しいただけるよう、退会は論理削除(フラグ管理)ではなく物理削除(データベースからの完全削除)で実装しています。</p>
                <p>また、退会と同時に退会ユーザーに関連する投稿、コメントも一緒に物理削除されますので、ぜひ安心してお試しいただければと思います。</p>
            </div>
        </div>
    </div>
</div>
